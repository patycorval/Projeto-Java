...
// // import com.example.reservaSala.model.ReservaService;
// // import com.example.reservaSala.model.model.Tool;
...
//     // public String atualizar(Model model, @PathVariable int id) { // id será
//     // passado como argumento para o método
//     // ReservaService cs = context.getBean(ReservaService.class); //O Spring
//     // automaticamente injeta uma instância de ReservaService
...
//     // @ModelAttribute instrui o Spring a vincular os dados do forms ao objeto
//     // Reserva.
...
//     // ReservaService cs = context.getBean(ReservaService.class);
//     // List<Map<String,Object>> lista = cs.obterTodasReservas(); //retorna uma lista
//     // onde cada mapa contém dados de uma reserva, tendo a chave "id" e seu valor
//     // correspondente
//     // List<Reserva> listaReservas = new ArrayList<Reserva>(); // lista contendo
//     // objetos do tipo Reserva.
//     // for(Map<String,Object> registro : lista){ //percorre cada registro e vai adc
//     // no array de Reserva
//     // listaReservas.add(Tool.converterReserva(registro));
//     // }
//     // model.addAttribute("reservas", listaReservas); //adc a lista de objetos
//     // Reserva ao modelo com o nome "reservas", para que esses dados possam ser
//     // usados na view
